...
d0 = np.array([1.696, 3.965, 11.252, 45.60, 102.6, 182.5]) # max stable depth for grid = 512 with disturbance of 0.1
d1 = np.array([1.712, 3.972, 11.260, 45.61, 102.8, 182.9]) # max stable depth for grid = 256 with disturbance of 0.1
...
def solve_quadratic(d):
    a = 182.80027907467993
    b = 0.045464332332812774
    c = -0.14717654147795045
